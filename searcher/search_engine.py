...
def search_exploits_in_db(search_text):
    if is_number(search_text):
        ...
        search_string = 'select * from exploits where ' + 'file like \'%' + search_text + '%\' or description like \'%' + search_text + '%\' or author like \'%' + search_text + '%\' or exploit_type like \'%' + search_text + '%\' or platform like \'%' + search_text + '%\''
    print(search_string)
