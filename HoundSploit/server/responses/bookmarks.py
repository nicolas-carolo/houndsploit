...
from HoundSploit.searcher.engine.bookmarks import get_bookmarks_list, get_filtered_bookmarks_list
...
def render_bookmarks(searched_text, current_bookmarks_page):
    ...
    index_first_result = get_index_first_result(current_bookmarks_page)
